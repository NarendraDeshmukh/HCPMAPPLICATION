...
import { LeaveBalanceContract } from 'app/models/leave/leaveBalanceContract.interface';
...
export class UserComponent implements OnInit {
  ...
  pageType: any = "";
  constructor(public apiService: ApiService, public paramService: ParameterService, public storageServ: StorageService,
  ...
  getWorkerDetails() {
    this.apiService.getWorkerDetails(this.paramService.email).subscribe(res => {
      console.log(res);
      this.emp = res;
  ...
  getLeaveBalanceDetails() {
    this.apiService.getLeaveType(this.paramService.emp.WorkerId).subscribe(res => {
  ...
  getDOB(date: any) {
    if (new Date(date).getFullYear() < 1920) {
      return "";
    } else {
  ...
  public getImageStr(imgSrc) {
    if (imgSrc == null || imgSrc == "") {
      ...
      var img = "data:image/jpeg;base64," + imgSrc;
